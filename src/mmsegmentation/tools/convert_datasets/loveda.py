...
def main():
    ...
    assert "Train.zip" in os.listdir(dataset_path), "Train.zip is not in {}".format(
        dataset_path
    )
    assert "Val.zip" in os.listdir(dataset_path), "Val.zip is not in {}".format(
        dataset_path
    )
    assert "Test.zip" in os.listdir(dataset_path), "Test.zip is not in {}".format(
        dataset_path
    )
