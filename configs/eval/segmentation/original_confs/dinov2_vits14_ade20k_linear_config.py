...
model = dict(
    ...
    pretrained=None,
    backbone=dict(
        type="DinoVisionTransformer", embed_dim=384, out_indices=[8, 9, 10, 11]
    ),
    decode_head=dict(
        type="BNHead",
        in_channels=[384],
...
auto_resume = True
gpu_ids = range(0, 8)
work_dir = "/srv/beegfs/scratch/users/p/pulfer/robustness_tokens/results/dinov2_vits14/segmentation/original_conf"
