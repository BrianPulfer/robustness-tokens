...
model = dict(
    type="EncoderDecoder",
    pretrained="/srv/beegfs/scratch/users/p/pulfer/robustness_tokens/results/dinov2_vits14_reg/last.pth",
    backbone=dict(
...
auto_resume = False
gpu_ids = [0]
work_dir = "/srv/beegfs/scratch/users/p/pulfer/robustness_tokens/results/dinov2_vits14_reg/segmentation"
